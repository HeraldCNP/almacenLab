...
new #[Layout('components.layouts.app')] class extends Component {
    ...
    public function mount(Material $material)
    {
        ...
        $this->unidad_medida_id = $material->unidad_medida_id;
        $this->stock_minimo = $material->stock_minimo;
    }
    ...
    public function update()
    {
        $validated = $this->validate([
            'codigo' => 'required|string|max:50|unique:materiales,codigo,' . $this->material->id,
        ...
        $this->material->update($validated);
